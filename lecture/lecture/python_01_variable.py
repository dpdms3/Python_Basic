...
# name 변수 생성
# "Ye Eun" 값을 name 변수에 담기

# name(변수명), =(대입연산자), "Ye Eun"(값)
name = "Ye Eun"
...
# 동적 출력!
print("=" * 200)
student_num = 20233138
student_name = "Ye Eun"

# 출력 예: 조선대학교 20233138, Ye Eun 입니다.
print("조선대학교 20233138, Ye Eun 입니다.")  # 하드 코딩 지양!
